 ...
 *
 * https://github.com/cdn77/coding-standard/blob/master/src/Cdn77CodingStandard/Sniffs/Classes/ClassStructureSniff.php
 */
class ClassStructureSniff implements Sniff
{
    ...
    public $requiredOrder = [
        ...
        self::STAGE_CONSTRUCTOR => 110,
        self::STAGE_STATIC_CONSTRUCTORS => 120,
        self::STAGE_DESTRUCTOR => 130,
        self::STAGE_PUBLIC_STATIC_METHODS => 140,
        self::STAGE_PUBLIC_METHODS => 150,
        self::STAGE_PROTECTED_STATIC_METHODS => 160,
        self::STAGE_PROTECTED_METHODS => 170,
        self::STAGE_PRIVATE_STATIC_METHODS => 180,
        self::STAGE_PRIVATE_METHODS => 190,
